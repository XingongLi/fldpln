...
Two kinds of installers are available to install the fldpln_model package and MATLAB Runtime it depends on. The smaller installer ([Windows](https://github.com/XingongLi/fldpln/blob/main/fldpln_model/fldpln_model_windows_installer_web.exe) and [Mac](https://github.com/XingongLi/fldpln/blob/main/fldpln_model/ffldpln_model_mac_installer_web.app.zip)) available on Github downloads the MATLAB Runtime on-the-fly during installation and the larger installer ([Windows](https://kbs-karsfl-pc01.home.ku.edu/download/fldpln_model_mac_installer_offline.app.zip) and [Mac](https://kbs-karsfl-pc01.home.ku.edu/download/fldpln_model_windows_installer_offline.exe)) available on a KU server has the MATLAB Runtime included in the installer. Whichever installer is used, it will install both the MATLAB Runtime and the fldpln_model package. 
